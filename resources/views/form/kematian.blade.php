...
<div>
    <form class="form-area" id="formArea">
        ...
        <div>
            <input type="text" name="tipe" value="sk" hidden>
        ...
        <div>
            ...
            <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label">Upload Surat Pernyatan RT/RW : </label>
                <input type="file" class="form-control" name="pernyataan" placeholder="Upload foto ktp anda">
            </div>

        
            <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label">Upload Foto/Fotocopy KK yang meninggal : </label>
                <input type="file" class="form-control" name="kk" placeholder="Upload surat penghasilan ">
            </div>

            <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label">Upload KTP yang meninggal : </label>
                <input type="file" class="form-control" name="ktp" placeholder="Upload foto ktp anda">
            </div>

        
            <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label">Upload KK dan KTP Ahli Waris : </label>
                <input type="file" class="form-control" name="ahli_waris" placeholder="Upload surat penghasilan ">
            </div>
        </div>
    </form>
    <center>
